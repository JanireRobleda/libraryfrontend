...
function CatBibliosPost() {
    ...
    function modifButton() {
        ...
        fetch("http://localhost:9000/catbiblios/post", fetchData) //le metemos la ruta en el servidor, y los datos que queremos que le meta. //cuando reciba la respuesta del app.get del index.js, entonces hacemos las 2 siguientes lineas.
    ...
    return (
        <main>
            <CatBibliosMainLeft />
            <div id="mainright">
                <h1>Añadir libro nuevo al catálogo de la biblioteca</h1>
                ...
                <div className="clinputs">
                    ...
                    <button onClick={modifButton} id="botonAnadirBiblio">Añadir libro a catálogo</button>
